...
- Java LTS releases 8, 11, 17, 21, 25
...
```clojure
{:deps {net.vivid-inc/art {:mvn/version "0.8.0"}}}         ; Clojure tools deps.edn
:dependencies [[net.vivid-inc/art "0.8.0"]]                ; Leiningen project.clj
```
