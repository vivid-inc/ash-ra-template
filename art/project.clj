...
(defproject net.vivid-inc/art "0.8.0"
  ...
  :aliases {"build"     ["do"
            ...
            "lint"      ["do"
                         ...
                         ["antq"]
                         ["nvd" "check"]]
            "test"      ["with-profile" "test" "with-profile" "+clojure-1.10.0:+clojure-1.10.3:+clojure-1.11.4:+clojure-1.12.4" "build"]}
  ...
  :dependencies [[instaparse/instaparse "1.5.0" :exclusions [org.clojure/spec.alpha]]
